...
export default {
  ...
  methods: {
    ...
    async search() {
      const url = ` https://api.themoviedb.org/3/search/tv?api_key=a37701b7a0845f3785cd83eb23add599&language=pt-BR&page=1&query=${this.valor_pesquisa}&include_adult=false`;
